(function (app) {
    ...
    humanListController.$inject = ['$scope', 'apiService', 'ModalService', 'notificationService', '$filter'];

    function humanListController($scope, apiService, ModalService, notificationService, $filter) {
        $scope.human = [];
        $scope.page = 0;
        $scope.pageCount = 0;
