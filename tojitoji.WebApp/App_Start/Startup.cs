...
[assembly: OwinStartup(typeof(tojitoji.WebApp.App_Start.Startup))]

namespace tojitoji.WebApp.App_Start
{
    public partial class Startup
    {
        ...
        private void ConfigAutofac(IAppBuilder app)
        {
            ...
            builder.RegisterType<tojitojiDbContext>().AsSelf().InstancePerRequest();
