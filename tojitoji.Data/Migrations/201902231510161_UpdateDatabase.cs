namespace tojitoji.Data.Migrations
{
    ...
    public partial class UpdateDatabase : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    Categories = c.String(maxLength: 256, unicode: false),
                    Categories_Type = c.Int(nullable: false),
                    MacroCategories = c.String(maxLength: 50, unicode: false),
                    CommercialCate = c.String(maxLength: 256),
                    Name_1 = c.String(maxLength: 256),
                    Name_2 = c.String(maxLength: 256),
                    Name_3 = c.String(maxLength: 256),
                    Name_4 = c.String(maxLength: 256),
                    Name_5 = c.String(maxLength: 256),
                    Name_6 = c.String(maxLength: 256),
                    NameEn_1 = c.String(maxLength: 256, unicode: false),
                    NameEn_2 = c.String(maxLength: 256, unicode: false),
                    NameEn_3 = c.String(maxLength: 256, unicode: false),
                    NameEn_4 = c.String(maxLength: 256, unicode: false),
                    NameEn_5 = c.String(maxLength: 256, unicode: false),
                    NameEn_6 = c.String(maxLength: 256, unicode: false),
                })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                {
                    ID = c.Int(nullable: false, identity: true),
                    Place_1 = c.String(maxLength: 256),
                    Place_2 = c.String(maxLength: 256),
                    Place_3 = c.String(maxLength: 256),
                    Place_4 = c.String(maxLength: 256),
            ...
            CreateTable(
                ...
                {
                    ID = c.Int(nullable: false, identity: true),
                    Type_1 = c.String(nullable: false, maxLength: 50),
                    Type_2 = c.String(maxLength: 50),
                    Type_3 = c.String(maxLength: 50),
                })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                c => new
                {
                    ID = c.Int(nullable: false, identity: true),
                    Name = c.String(maxLength: 256),
                    LoaiTaiSanID = c.Int(nullable: false),
                })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.LoaiTaiSans", t => t.LoaiTaiSanID, cascadeDelete: true)
                .Index(t => t.LoaiTaiSanID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TaiSans", "LoaiTaiSanID", "dbo.LoaiTaiSans");
            ...
            DropIndex("dbo.TaiSans", new[] { "LoaiTaiSanID" });
            ...
            DropIndex("dbo.Humans", new[] { "Email" });
            ...
            DropIndex("dbo.Bibles", new[] { "Shortcut" });
